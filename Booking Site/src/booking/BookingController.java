...
public class BookingController
{
	 ...
	 * @param books List of bookings to filter
	 * @param business Business to only return bookings of
	 * @param date Only return bookings on this date -ignore 01/01/2000
	 * @param startTime Returns only bookings after this time
	 * @param finishTime Returns only bookings before this time
	 * @param employee Returns only this employees bookings
	 * @param user Returns only bookings reserved by this user
	 * @param type Returns only bookings of given type
