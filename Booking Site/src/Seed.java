	...
	public static void initialize() {
		...
		try {
			...
			sql = "CREATE TABLE Booking(" + "Date TEXT NOT NULL, " + "StartTime TEXT NOT NULL, "
					+ "FinishTime NOT NULL, " + "EmployeeEmail TEXT NOT NULL, " + "Username TEXT, " + "Type TEXT, "
			...
			dataCont.getState().setString(2, "abc123");
			dataCont.getState().setString(3, "Sam Customer");
			dataCont.getState().setString(4, "0455555555");
			dataCont.getState().setString(5, "Customer");
			dataCont.getState().setString(6, "123 Customer st");
			dataCont.getState().setString(7, "samcustomer@example.com");
			dataCont.runSQLUpdate();
			...
			// Booking 1
//			sql = "INSERT INTO Booking(Date, StartTime, FinishTime, EmployeeEmail, Username) " + "VALUES(?,?,?,?,?)";
//			dataCont.runSQLUpdate();
//			dataCont.prepareStatement(sql);
//			dataCont.getState().setString(1, "");
//			dataCont.getState().setString(2, "10:00");
//			dataCont.getState().setString(3, "11:00");
//			dataCont.getState().setString(4, "janeoliver@example.com");
//			dataCont.getState().setString(4, "cus001");
//			dataCont.runSQLUpdate();
